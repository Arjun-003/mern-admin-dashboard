...
function AboutUs() {
  ...
  const getAboutus = async () => {
    const response = await getDataByParams(`${ApiEndPoint.cms}`, 1);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded px-4 py-2 bold font-bold bg-gray-200"
                  disabled
                />
              </div>
              ...
              <button
                type="submit"
                className="text-white font-medium px-6 py-2 rounded shadow transition-all duration-300 hover:opacity-90 bg-gray-900"
              >
                Update
              </button>
            </form>
