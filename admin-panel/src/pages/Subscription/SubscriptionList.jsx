...
function SubscriptionList() {
  ...
  const fetchSubscriptions = useCallback(
    async (page, limit, search = "") => {
      try {
        ...
        const url = `${ApiEndPoint.subscriptionList}?${queryParams.toString()}`;
  ...
  useEffect(() => {
    fetchSubscriptions(currentPage, entriesPerPage, debouncedSearchQuery);
  ...
  const handleDeleteSubscription = async (id, title) => {
    Swal.fire({
      title: "Are you sure?",
      text: `Are you sure you want to delete subscription: ${title}?`,
      icon: "warning",
      ...
      if (r.isConfirmed) {
        try {
          await deleteData(`${ApiEndPoint.deleteSubscription}/${id}`);
          Swal.fire({
            icon: "success",
            title: "Deleted!",
            timer: 1500,
  ...
  const handleAddSubscription = () => navigate("/subscription_add");
                    ...
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm font-medium space-x-3">
                        <button
                          ...
                          onClick={() =>
                            navigate(`/subscription_edit/${item.id}`)
                          }
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleDeleteSubscription(item.id, item.title)
                          }
